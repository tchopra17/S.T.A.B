...
public class MainMenu extends JPanel {
	...
	public MainMenu() {
		...
		instructionButton.setBounds(g.returnWidth() / 2 - buttonW / 2, playButton.getY() + spacing, buttonW, buttonH);

		quitButton = new JButton("Quit");
		quitButton.setBounds(g.returnWidth() / 2 - buttonW / 2, instructionButton.getY() + spacing, buttonW, buttonH);
